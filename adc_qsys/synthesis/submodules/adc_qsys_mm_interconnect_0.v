...
module adc_qsys_mm_interconnect_0 (
	...
	wire          cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> sdramPLL_pll_slave_agent:cp_valid
	wire  [103:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> sdramPLL_pll_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                              // sdramPLL_pll_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> sdramPLL_pll_slave_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> sdramPLL_pll_slave_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> sdramPLL_pll_slave_agent:cp_endofpacket
	...
	wire          sdrampll_pll_slave_agent_rp_valid;                                                  // sdramPLL_pll_slave_agent:rp_valid -> router_004:sink_valid
	wire  [103:0] sdrampll_pll_slave_agent_rp_data;                                                   // sdramPLL_pll_slave_agent:rp_data -> router_004:sink_data
	wire          sdrampll_pll_slave_agent_rp_ready;                                                  // router_004:sink_ready -> sdramPLL_pll_slave_agent:rp_ready
	wire          sdrampll_pll_slave_agent_rp_startofpacket;                                          // sdramPLL_pll_slave_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          sdrampll_pll_slave_agent_rp_endofpacket;                                            // sdramPLL_pll_slave_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire    [4:0] cmd_demux_001_src4_channel;                                                         // cmd_demux_001:src4_channel -> crosser_001:in_channel
	...
	wire    [4:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_001:sink4_channel
	...
	wire          sdrampll_pll_slave_agent_rdata_fifo_src_valid;                                      // sdramPLL_pll_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] sdrampll_pll_slave_agent_rdata_fifo_src_data;                                       // sdramPLL_pll_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          sdrampll_pll_slave_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_002:in_0_ready -> sdramPLL_pll_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                                  // avalon_st_adapter_002:out_0_valid -> sdramPLL_pll_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                                   // avalon_st_adapter_002:out_0_data -> sdramPLL_pll_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                                  // sdramPLL_pll_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                                  // avalon_st_adapter_002:out_0_error -> sdramPLL_pll_slave_agent:rdata_fifo_sink_error
	...
	adc_qsys_mm_interconnect_0_router router_001 (
	...
	adc_qsys_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_50_clk_clk),                                 //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (sdramPLL_c0_clk),                         //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (sdramPLL_c0_clk),                              //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_50_clk_clk),                                 //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_avalon_st_adapter_004 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
