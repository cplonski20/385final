...
`timescale 1 ps / 1 ps
module adc_qsys_mm_interconnect_0 (
		input  wire        clk_50_clk_clk,                                               //                                             clk_50_clk.clk
		input  wire        sdramPLL_c0_clk,                                              //                                            sdramPLL_c0.clk
		...
		output wire [1:0]  sdramPLL_pll_slave_address,                                   //                                     sdramPLL_pll_slave.address
		output wire        sdramPLL_pll_slave_write,                                     //                                                       .write
		output wire        sdramPLL_pll_slave_read,                                      //                                                       .read
		input  wire [31:0] sdramPLL_pll_slave_readdata,                                  //                                                       .readdata
		output wire [31:0] sdramPLL_pll_slave_writedata,                                 //                                                       .writedata
	...
	wire  [104:0] i2c_0_csr_agent_rf_source_data;                                                     // i2c_0_csr_agent:rf_source_data -> i2c_0_csr_agent_rsp_fifo:in_data
	...
	wire  [104:0] i2c_0_csr_agent_rsp_fifo_out_data;                                                  // i2c_0_csr_agent_rsp_fifo:out_data -> i2c_0_csr_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> i2c_0_csr_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // i2c_0_csr_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [6:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> i2c_0_csr_agent:cp_channel
	...
	wire   [31:0] sdrampll_pll_slave_agent_m0_readdata;                                               // sdramPLL_pll_slave_translator:uav_readdata -> sdramPLL_pll_slave_agent:m0_readdata
	wire          sdrampll_pll_slave_agent_m0_waitrequest;                                            // sdramPLL_pll_slave_translator:uav_waitrequest -> sdramPLL_pll_slave_agent:m0_waitrequest
	wire          sdrampll_pll_slave_agent_m0_debugaccess;                                            // sdramPLL_pll_slave_agent:m0_debugaccess -> sdramPLL_pll_slave_translator:uav_debugaccess
	wire   [27:0] sdrampll_pll_slave_agent_m0_address;                                                // sdramPLL_pll_slave_agent:m0_address -> sdramPLL_pll_slave_translator:uav_address
	wire    [3:0] sdrampll_pll_slave_agent_m0_byteenable;                                             // sdramPLL_pll_slave_agent:m0_byteenable -> sdramPLL_pll_slave_translator:uav_byteenable
	wire          sdrampll_pll_slave_agent_m0_read;                                                   // sdramPLL_pll_slave_agent:m0_read -> sdramPLL_pll_slave_translator:uav_read
	wire          sdrampll_pll_slave_agent_m0_readdatavalid;                                          // sdramPLL_pll_slave_translator:uav_readdatavalid -> sdramPLL_pll_slave_agent:m0_readdatavalid
	wire          sdrampll_pll_slave_agent_m0_lock;                                                   // sdramPLL_pll_slave_agent:m0_lock -> sdramPLL_pll_slave_translator:uav_lock
	wire   [31:0] sdrampll_pll_slave_agent_m0_writedata;                                              // sdramPLL_pll_slave_agent:m0_writedata -> sdramPLL_pll_slave_translator:uav_writedata
	wire          sdrampll_pll_slave_agent_m0_write;                                                  // sdramPLL_pll_slave_agent:m0_write -> sdramPLL_pll_slave_translator:uav_write
	wire    [2:0] sdrampll_pll_slave_agent_m0_burstcount;                                             // sdramPLL_pll_slave_agent:m0_burstcount -> sdramPLL_pll_slave_translator:uav_burstcount
	wire          sdrampll_pll_slave_agent_rf_source_valid;                                           // sdramPLL_pll_slave_agent:rf_source_valid -> sdramPLL_pll_slave_agent_rsp_fifo:in_valid
	wire  [104:0] sdrampll_pll_slave_agent_rf_source_data;                                            // sdramPLL_pll_slave_agent:rf_source_data -> sdramPLL_pll_slave_agent_rsp_fifo:in_data
	wire          sdrampll_pll_slave_agent_rf_source_ready;                                           // sdramPLL_pll_slave_agent_rsp_fifo:in_ready -> sdramPLL_pll_slave_agent:rf_source_ready
	wire          sdrampll_pll_slave_agent_rf_source_startofpacket;                                   // sdramPLL_pll_slave_agent:rf_source_startofpacket -> sdramPLL_pll_slave_agent_rsp_fifo:in_startofpacket
	wire          sdrampll_pll_slave_agent_rf_source_endofpacket;                                     // sdramPLL_pll_slave_agent:rf_source_endofpacket -> sdramPLL_pll_slave_agent_rsp_fifo:in_endofpacket
	wire          sdrampll_pll_slave_agent_rsp_fifo_out_valid;                                        // sdramPLL_pll_slave_agent_rsp_fifo:out_valid -> sdramPLL_pll_slave_agent:rf_sink_valid
	wire  [104:0] sdrampll_pll_slave_agent_rsp_fifo_out_data;                                         // sdramPLL_pll_slave_agent_rsp_fifo:out_data -> sdramPLL_pll_slave_agent:rf_sink_data
	wire          sdrampll_pll_slave_agent_rsp_fifo_out_ready;                                        // sdramPLL_pll_slave_agent:rf_sink_ready -> sdramPLL_pll_slave_agent_rsp_fifo:out_ready
	wire          sdrampll_pll_slave_agent_rsp_fifo_out_startofpacket;                                // sdramPLL_pll_slave_agent_rsp_fifo:out_startofpacket -> sdramPLL_pll_slave_agent:rf_sink_startofpacket
	wire          sdrampll_pll_slave_agent_rsp_fifo_out_endofpacket;                                  // sdramPLL_pll_slave_agent_rsp_fifo:out_endofpacket -> sdramPLL_pll_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> sdramPLL_pll_slave_agent:cp_valid
	wire  [103:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> sdramPLL_pll_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // sdramPLL_pll_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> sdramPLL_pll_slave_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> sdramPLL_pll_slave_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> sdramPLL_pll_slave_agent:cp_endofpacket
	...
	wire   [27:0] altpll_sys_pll_slave_agent_m0_address;                                              // altpll_sys_pll_slave_agent:m0_address -> altpll_sys_pll_slave_translator:uav_address
	...
	wire  [104:0] altpll_sys_pll_slave_agent_rf_source_data;                                          // altpll_sys_pll_slave_agent:rf_source_data -> altpll_sys_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [104:0] altpll_sys_pll_slave_agent_rsp_fifo_out_data;                                       // altpll_sys_pll_slave_agent_rsp_fifo:out_data -> altpll_sys_pll_slave_agent:rf_sink_data
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> altpll_sys_pll_slave_agent:cp_valid
	wire  [103:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> altpll_sys_pll_slave_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // altpll_sys_pll_slave_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> altpll_sys_pll_slave_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> altpll_sys_pll_slave_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> altpll_sys_pll_slave_agent:cp_endofpacket
	...
	wire  [103:0] i2c_0_csr_agent_rp_data;                                                            // i2c_0_csr_agent:rp_data -> router_003:sink_data
	...
	wire          sdrampll_pll_slave_agent_rp_valid;                                                  // sdramPLL_pll_slave_agent:rp_valid -> router_005:sink_valid
	wire  [103:0] sdrampll_pll_slave_agent_rp_data;                                                   // sdramPLL_pll_slave_agent:rp_data -> router_005:sink_data
	wire          sdrampll_pll_slave_agent_rp_ready;                                                  // router_005:sink_ready -> sdramPLL_pll_slave_agent:rp_ready
	wire          sdrampll_pll_slave_agent_rp_startofpacket;                                          // sdramPLL_pll_slave_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          sdrampll_pll_slave_agent_rp_endofpacket;                                            // sdramPLL_pll_slave_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          altpll_sys_pll_slave_agent_rp_valid;                                                // altpll_sys_pll_slave_agent:rp_valid -> router_006:sink_valid
	wire  [103:0] altpll_sys_pll_slave_agent_rp_data;                                                 // altpll_sys_pll_slave_agent:rp_data -> router_006:sink_data
	wire          altpll_sys_pll_slave_agent_rp_ready;                                                // router_006:sink_ready -> altpll_sys_pll_slave_agent:rp_ready
	wire          altpll_sys_pll_slave_agent_rp_startofpacket;                                        // altpll_sys_pll_slave_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          altpll_sys_pll_slave_agent_rp_endofpacket;                                          // altpll_sys_pll_slave_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire          sdrampll_pll_slave_agent_rdata_fifo_src_valid;                                      // sdramPLL_pll_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] sdrampll_pll_slave_agent_rdata_fifo_src_data;                                       // sdramPLL_pll_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          sdrampll_pll_slave_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_003:in_0_ready -> sdramPLL_pll_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> sdramPLL_pll_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> sdramPLL_pll_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                                  // sdramPLL_pll_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> sdramPLL_pll_slave_agent:rdata_fifo_sink_error
	wire          altpll_sys_pll_slave_agent_rdata_fifo_src_valid;                                    // altpll_sys_pll_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] altpll_sys_pll_slave_agent_rdata_fifo_src_data;                                     // altpll_sys_pll_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          altpll_sys_pll_slave_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_004:in_0_ready -> altpll_sys_pll_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> altpll_sys_pll_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> altpll_sys_pll_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                  // altpll_sys_pll_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> altpll_sys_pll_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) sdrampll_pll_slave_translator (
		.clk                    (clk_50_clk_clk),                                 //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (sdrampll_pll_slave_agent_m0_address),            // avalon_universal_slave_0.address
		.uav_burstcount         (sdrampll_pll_slave_agent_m0_burstcount),         //                         .burstcount
		.uav_read               (sdrampll_pll_slave_agent_m0_read),               //                         .read
		.uav_write              (sdrampll_pll_slave_agent_m0_write),              //                         .write
		.uav_waitrequest        (sdrampll_pll_slave_agent_m0_waitrequest),        //                         .waitrequest
		.uav_readdatavalid      (sdrampll_pll_slave_agent_m0_readdatavalid),      //                         .readdatavalid
		.uav_byteenable         (sdrampll_pll_slave_agent_m0_byteenable),         //                         .byteenable
		.uav_readdata           (sdrampll_pll_slave_agent_m0_readdata),           //                         .readdata
		.uav_writedata          (sdrampll_pll_slave_agent_m0_writedata),          //                         .writedata
		.uav_lock               (sdrampll_pll_slave_agent_m0_lock),               //                         .lock
		.uav_debugaccess        (sdrampll_pll_slave_agent_m0_debugaccess),        //                         .debugaccess
		.av_address             (sdramPLL_pll_slave_address),                     //      avalon_anti_slave_0.address
		.av_write               (sdramPLL_pll_slave_write),                       //                         .write
		.av_read                (sdramPLL_pll_slave_read),                        //                         .read
		.av_readdata            (sdramPLL_pll_slave_readdata),                    //                         .readdata
		.av_writedata           (sdramPLL_pll_slave_writedata),                   //                         .writedata
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
		.av_byteenable          (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) sdrampll_pll_slave_agent (
		.clk                     (clk_50_clk_clk),                                      //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (sdrampll_pll_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (sdrampll_pll_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (sdrampll_pll_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (sdrampll_pll_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (sdrampll_pll_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (sdrampll_pll_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (sdrampll_pll_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (sdrampll_pll_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (sdrampll_pll_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (sdrampll_pll_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (sdrampll_pll_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (sdrampll_pll_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (sdrampll_pll_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (sdrampll_pll_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (sdrampll_pll_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (sdrampll_pll_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (sdrampll_pll_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (sdrampll_pll_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (sdrampll_pll_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (sdrampll_pll_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (sdrampll_pll_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (sdrampll_pll_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (sdrampll_pll_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (sdrampll_pll_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (sdrampll_pll_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (sdrampll_pll_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (sdrampll_pll_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (sdrampll_pll_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (sdrampll_pll_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sdrampll_pll_slave_agent_rsp_fifo (
		.clk               (clk_50_clk_clk),                                      //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (sdrampll_pll_slave_agent_rf_source_data),             //        in.data
		.in_valid          (sdrampll_pll_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (sdrampll_pll_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (sdrampll_pll_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (sdrampll_pll_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (sdrampll_pll_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (sdrampll_pll_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (sdrampll_pll_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (sdrampll_pll_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (sdrampll_pll_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	adc_qsys_mm_interconnect_0_router router (
	...
	adc_qsys_mm_interconnect_0_router_001 router_001 (
	...
	adc_qsys_mm_interconnect_0_router_002 router_002 (
	...
	adc_qsys_mm_interconnect_0_router_002 router_003 (
	...
	adc_qsys_mm_interconnect_0_router_002 router_004 (
	...
	adc_qsys_mm_interconnect_0_router_002 router_005 (
		.sink_ready         (sdrampll_pll_slave_agent_rp_ready),              //      sink.ready
		.sink_valid         (sdrampll_pll_slave_agent_rp_valid),              //          .valid
		.sink_data          (sdrampll_pll_slave_agent_rp_data),               //          .data
		.sink_startofpacket (sdrampll_pll_slave_agent_rp_startofpacket),      //          .startofpacket
		.sink_endofpacket   (sdrampll_pll_slave_agent_rp_endofpacket),        //          .endofpacket
		.clk                (clk_50_clk_clk),                                 //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_router_006 router_006 (
	...
	adc_qsys_mm_interconnect_0_router_002 router_007 (
	...
	adc_qsys_mm_interconnect_0_router_008 router_008 (
	...
	adc_qsys_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_50_clk_clk),                                 //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_50_clk_clk),                                 //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_50_clk_clk),                                 //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_50_clk_clk),                                 //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_50_clk_clk),                                 //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_50_clk_clk),                                 //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_cmd_mux_004 cmd_mux_004 (
		.clk                 (clk_50_clk_clk),                                               //       clk.clk
		.reset               (altpll_sys_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_50_clk_clk),                                 //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (sdramPLL_c0_clk),                         //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_50_clk_clk),                                 //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_50_clk_clk),                                 //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_50_clk_clk),                                 //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_50_clk_clk),                                 //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (clk_50_clk_clk),                                               //       clk.clk
		.reset              (altpll_sys_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_50_clk_clk),                                 //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (sdramPLL_c0_clk),                              //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_50_clk_clk),                                 //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_qsys_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_50_clk_clk),                                 //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_clk           (sdramPLL_c0_clk),                                //       out_clk.clk
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_clk            (sdramPLL_c0_clk),                                //        in_clk.clk
	...
	adc_qsys_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	adc_qsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_50_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (sdrampll_pll_slave_agent_rdata_fifo_src_data),   //     in_0.data
		.in_0_valid     (sdrampll_pll_slave_agent_rdata_fifo_src_valid),  //         .valid
		.in_0_ready     (sdrampll_pll_slave_agent_rdata_fifo_src_ready),  //         .ready
	...
	adc_qsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (altpll_sys_pll_slave_agent_rdata_fifo_src_data),               //     in_0.data
		.in_0_valid     (altpll_sys_pll_slave_agent_rdata_fifo_src_valid),              //         .valid
		.in_0_ready     (altpll_sys_pll_slave_agent_rdata_fifo_src_ready),              //         .ready
	...
	adc_qsys_mm_interconnect_0_avalon_st_adapter_006 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
		...
		.in_clk_0_clk   (sdramPLL_c0_clk),                         // in_clk_0.clk
