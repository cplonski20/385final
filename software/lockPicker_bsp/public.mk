...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../adc_qsys.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2b8
SOPC_SYSID_FLAG += --sidp=0x2b8
ELF_PATCH_FLAG  += --sidp 0x2b8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1651873710
SOPC_SYSID_FLAG += --timestamp=1651873710
ELF_PATCH_FLAG  += --timestamp 1651873710
